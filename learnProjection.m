function [P_img, P_txt] = learnProjection(I_tr, I_te, T_tr, T_te, pair, img_Dim, txt_Dim, tr_n_I, tr_n_T, L_cat_img, L_cat_txt, cat_Num, param)
...
for i = 1:iteration
    ...
    LA = graphCons([I_proj,T_proj]', 100);
